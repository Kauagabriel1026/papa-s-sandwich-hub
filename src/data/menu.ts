...
import { MONDAY, type Weekday } from "@/lib/schedule";

export type Category =
  "promocoes" | "hamburguer" | "lombo" | "frango" | "porcoes" | "acai" | "bebidas" | "adicionais";
...
export interface MenuItem {
  ...
  badge?: string;
  /**
   * Em quais dias da semana o item é vendido (0 = domingo ... 6 = sábado).
   * Não preencher significa "vendido todo dia" — que é o caso da esmagadora
   * maioria do cardápio, então só os itens com data marcada declaram isso.
   */
...
export const menuItems: MenuItem[] = [
  ...
  // ── Porções ─────────────────────────────
  {
    ...
    price: 16.0,
    category: "porcoes",
    image: imgComboFritas.url,
  },
  {
    id: "bt-recheada-p",
    name: "Batata Recheada (P)",
    description: "Acompanha cheddar, mussarela, bacon e calabresa.",
    price: 22.0,
    category: "porcoes",
    image: imgBatata.url,
    popular: true,
  ...
  },
  {
    ...
    price: 21.5,
    category: "porcoes",
    image: imgBatataG.url,
  },
  {
    id: "bt-recheada-g",
    name: "Batata Recheada (G)",
    description: "Acompanha cheddar, mussarela, bacon e calabresa.",
    price: 27.0,
    category: "porcoes",
    image: imgBatataG.url,
  ...
  {
    id: "cebola-p",
    name: "Cebola Empanada (P)",
    description: "Porção pequena de anéis de cebola empanados.",
    price: 16.0,
    category: "porcoes",
    image: imgAnel.url,
  },
  {
    id: "cebola-m",
    name: "Cebola Empanada (M)",
    description: "Porção média de anéis de cebola empanados.",
    price: 23.0,
    category: "porcoes",
    image: imgAnel.url,
  },
  {
    id: "nuggets-p",
    name: "Nuggets (P)",
    description: "Porção pequena de nuggets de frango.",
    price: 12.0,
    category: "porcoes",
    image: imgNuggets.url,
  },
  ...
  // ── Açaí, cremes e sucos ─────────────────────────────
  {
    id: "acai-350",
    name: "Açaí 350ml",
    description: "Monte com os adicionais da casa.",
    price: 20.0,
    category: "acai",
    image: imgAcai2.url,
  },
  ...
  },
  {
    id: "creme-500",
    name: "Creme 500ml",
    description: "Escolha o sabor na observação do pedido.",
    price: 13.0,
    category: "acai",
    image: imgCreme.url,
  },
  ...
  },
  {
    id: "suco-lafruit",
    name: "Suco Lafruit",
    description: "Suco pronto gelado.",
    price: 9.0,
    category: "bebidas",
  },
